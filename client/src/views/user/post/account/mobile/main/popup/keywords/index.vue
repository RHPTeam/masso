  ...
  <div class="modal--confirm-password">
    ...
    <div class="items--main mt_3 px_3">
      <div class="list">
        ...
        <ul class="p_0 m_0">
          <li class="d_flex align_items_center item">
            <span>Girl</span>
            <span class="ml_auto" @click="showPopupDelete">Xóa</span>
          </li>
          <li class="d_flex align_items_center item">
            <span>Xinh</span>
            <span class="ml_auto">Xóa</span>
          </li>
          <li class="d_flex align_items_center item">
            <span>Lắm</span>
            <span class="ml_auto">Xóa</span>
    ...
    <transition name="popup--mobile">
      <popup-add-keywords @closeAddKeywords="isShowPopupAddKeywords = $event" v-if="isShowPopupAddKeywords === true"/>
    </transition>
    <!-- End: Popup Mobile -->
    <!-- Start: Popup Delete -->
