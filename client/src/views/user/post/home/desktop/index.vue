      ...
      <div class="main--content">
        <div class="overview">
          ...
          <div class="r total mx_0">
            <!-- Start: Posts -->
              <div class="pl_0 c_3 c_md_6 c_lg_3 text_center">
                <div class="wrap">
                  <div class="icon">
                    <icon-base
                      class="icon--post"
              ...
              <!-- End: Posts -->
              <!-- Start: Campaigns -->
              <div class="c_3 c_md_6 c_lg_3 pr_lg_3 pr_md_0 text_center">
                <div class="wrap">
                  <div class="icon">
                    <icon-base
              ...
              <!-- End: Campaigns -->
              <!-- Start: Groups -->
              <div class="c_3 c_md_6 c_lg_3 pl_lg_3 pl_md_0 text_center">
                <div class="wrap">
                  <div class="icon">
                    <icon-base
                      class="icon--group"
              ...
              <!-- End: Groups -->
              <!-- Start: Pages -->
              <div class="c_3 c_md_6 c_lg_3 text_center pr_0">
                <div class="wrap">
                  <div class="icon">
                    <icon-base
                      class="icon--page"
          ...
          <div class="order--server-history mx_0 mb_3 r">
            ...
            <div
              class="c_md_12 c_lg_12 c_xl_6 line--chart mt_md_3 mt_lg_0 pt_3">
              <VueApexCharts
                type="line"
                height="350"
