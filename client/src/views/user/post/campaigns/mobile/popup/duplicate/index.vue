    ...
    <div class="modal--dialog d_flex justify_content_center align_items_center">
      ...
      <div class="modal--content text_center" v-click-outside="closePopup">
        <div class="item mb_2 delete">
          <div class="text mb_2 pb_2 px_1">Bạn có muốn sao chép chiến dịch <b>{{ campaign.title }}</b> này không?</div>
          <div @click="duplicateCampaign">Sao chép</div>
        </div>
...
export default {
  ...
  methods: {
    ...
    duplicateCampaign() {
      this.$store.dispatch( "duplicateCampaign", this.campaign._id );
      const dataSender = {
        size: 25,
        page: 1
      };
