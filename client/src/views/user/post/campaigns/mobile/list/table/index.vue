<template>
  <div class="campaigns--data mt_3" :data-theme="currentTheme">
    <!-- Start: Table Header -->
    ...
    <div class="p_3" v-if="campaignStatus === 'loading'">
    ...
    >
      ...
      >
        ...
        <div class="col col--desc px_4">
          <div class="col--desc-text">{{ campaign.description }}</div>
        </div>
        <div class="col col--start px_2">{{ formatDate(campaign.started_at) }}</div>
        <div class="col col--status px_2">
          <div class="status--content d_flex align_items_center">
            <div
              class="status--dot mr_2"
              :class="[ campaign.status ? 'dot--active' : 'dot--deactive' ]"
            ></div>
            <div class="status--text" v-if="campaign.status">Đang hoạt động</div>
            <div class="status--text" v-else>Ngừng hoạt động</div>
          </div>
        </div>
