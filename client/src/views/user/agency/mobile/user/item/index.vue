<template>
  <div class="item--body px_2 py_2 mb_2 d_flex align_items_center" v-if="member" @click="editMember">
    <div class="info">
      <!-- Start: Email Column -->
    ...
    <!-- Start: Action Column -->
    <div class="col d_flex align_items_center justify_content_center col--action text_center ml_auto">
