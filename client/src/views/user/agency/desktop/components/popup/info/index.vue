  ...
  <div class="modal--wrapper">
    <div class="modal--dialog d_flex justify_content_center">
      <div class="modal--content px_4 py_3">
        <VuePerfectScrollbar class="scroll-agency">
          <!-- Start: Modal Body -->
          <div class="body">
            <!-- Start: Form Header -->
            ...
            <!-- Start: Alert error -->
            <div class="mb_2 error--text" v-if="isShowErrorAgency === true">{{errorAgency}}</div>
            <!-- Start: Alert error -->
            ...
            <form>
              ...
              >
                ...
                <input id="nameField" type="text" placeholder="Họ tên" v-model="user.name" />
              </div>
              <div class="text--error">{{ errorText.name }}</div>
              <div class="font_weight_bold mb_1">Email đăng ký</div>
              <div
                class="form_group position_relative"
                :class="{
              ...
              >
                ...
                <input id="emailField" type="email" placeholder="Email" v-model="user.email" />
                <span class="text--error"></span>
              </div>
              <div class="text--error">{{ errorText.email }}</div>
              <div class="font_weight_bold mb_1">Số điện thoại</div>
              <div
                class="form_group position_relative"
                :class="{
              ...
              >
                ...
                >{{ network }}</div>
                <input id="phoneField" type="text" placeholder="Số điện thoại" v-model="user.phone" />
                <span class="text--error"></span>
              </div>
              <div class="text--error">{{ errorText.phone }}</div>
              <div class="font_weight_bold mb_1">Mật khẩu</div>
              <div
                class="form_group position_relative"
                :class="{
              ...
              <div class="font_weight_bold mb_1">Xác nhận mật khẩu</div>
              <div
                class="form_group position_relative"
                :class="{
        ...
        <div class="footer d_flex align_items_center mt_3">
          <div class="ml_auto d_flex">
            <button class="btn--cancel mr_2" @click="close">Hủy bỏ</button>
            <button class="btn--create" @click="createNewMember">Tạo mới</button>
          </div>
        </div>
        <!-- End: Modal Footer -->
      </div>
