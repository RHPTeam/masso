    ...
    <div class="modal--dialog d_flex justify_content_center">
      <div class="modal--content px_4 py_3">
        ...
        <div class="header text_center mb_3">
          ...
          <div class="desc">Chào mừng bạn đến với hệ thống Marketting Online của Zinbee.</div>
        </div>
        <!-- End: Modal Header -->
        <!-- Start: Modal Body -->
        <div class="body mb_2">
          ...
          <div class="card mb_2" @click="gotoServer(2)">
            <div class="card_body">
              <div class="d_flex align_items_center justify_content_between">
                <div class="detail">
                  <div class="text--bold">Miền Trung</div>
                  <div class="desc">https://inbox.zinbee.vn</div>
                  <div class="desc">https://chat.zinbee.vn</div>
                </div>
                <div class="action">
          ...
          <div class="card" @click="gotoServer(3)">
            <div class="card_body">
              <div class="d_flex align_items_center justify_content_between">
                <div class="detail">
                  <div class="text--bold">Miền Nam</div>
                  <div class="desc">https://inbox.zinbee.vn</div>
                  <div class="desc">https://chat.zinbee.vn</div>
                </div>
                <div class="action">
        ...
        <!-- End: Modal Body -->
        <!-- Start: Modal Footer -->
        <div class="footer d_flex align_items_center justify_content_center mt_3" v-if="isShowButtonFinal === true">
          <button class="btn bg_primary" @click="redirectServer">Hoàn thành</button>
        </div>
        <!-- End: Modal Footer -->
      </div>
    </div>
