<template>
  <div class="position_absolute" style="bottom: 1rem; left: 1rem;" v-if="accountFacebookList.length > 0">

    <!-- Then put toasts within -->
    <div class="toast fade show" role="alert" data-autohide="false" aria-live="assertive" aria-atomic="true" v-for="facebook in accountFacebookList" :key="facebook._id" v-if="facebook.status === false" @click="goToAccountFacebook">
