<template>
  <div class="add--catagory card_body card mt_2" :data-theme="currentTheme">
    ...
    <div v-if="isShowAlert === true" class="text_danger">Tên danh mục không được bỏ trống</div>
    <div class="my_2">Danh mục cha</div>
    <span
      class="text_danger"
    >Nếu không lựa chọn trong danh mục này thì mặc định danh mục được tạo ở trên là danh mục cha</span>
    ...
    <button class="btn btn_info mt_3" @click="createNewCateAdmin">Tạo mới</button>
  </div>
</template>
