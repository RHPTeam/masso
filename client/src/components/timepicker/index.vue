...
<span class="time-picker" @keydown="onKeyDown">
  ...
  <div class="dropdown" v-show="showDropdown" @focusout="onLoseFocus">
    <div class="select-list">
      <select class="hours" v-model="value[hourType]" @change="$emit('change', value)">
      ...
      <select class="minutes" v-model="value[minuteType]" @change="$emit('change', value)">
      ...
      <select class="seconds" v-model="value[secondType]" v-if="secondType" @change="$emit('change', value)">
      ...
      <select class="apms" v-model="value[apmType]" v-if="apmType" @change="$emit('change', value)">
